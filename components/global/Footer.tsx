...
export default function Footer() {
    ...
    return (
        <footer className="bg-black/50 text-white backdrop-blur-sm border-t border-gray-700/50 transition-shadow duration-300 ease-in-out hover:shadow-[0_-10px_25px_-5px_rgba(76,5,119,0.4)] mt-10">
