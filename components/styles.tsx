export const classNames = {
    cardparent_divisions:
        "w-full md:w-1/2 flex justify-center flex-col items-center p-4 md:p-10 md:pl-20 cursor-default",
    ...
    boxHoverEffect:
        "transition-all duration-300 ease-in-out hover:shadow-[0_0_20px_rgba(139,92,246,0.5)] hover:border-purple-500",
